    ...
    <footer className="bg-[#0B2E5B] text-white relative overflow-hidden font-sans">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20">
        <div className="grid gap-8 sm:gap-10 md:gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4 sm:mb-6">
              <h3 className="text-lg sm:text-xl md:text-2xl font-black leading-tight tracking-tight uppercase italic">
                Srivruksh <br/>
                <span className="text-[#C79A3B] text-[8px] sm:text-[10px] tracking-[0.25em] sm:tracking-[0.5em] font-bold block mt-1">
                  Industries
                </span>
              </h3>
            </div>

            <p className="text-gray-300 text-sm sm:text-[14px] md:text-[15px] leading-relaxed mb-5 sm:mb-8 max-w-sm font-medium opacity-80">
            ...
            <div className="flex gap-2 sm:gap-3 flex-wrap">
              <a className="bg-white/5 hover:bg-[#C79A3B] transition p-2 sm:p-2.5 rounded-lg sm:rounded-xl border border-white/10">
          ...
          {/* Sitemap */}
          <div>
            <h4 className="text-[9px] sm:text-xs md:text-sm font-black mb-4 sm:mb-7 text-[#C79A3B] uppercase tracking-[0.2em] sm:tracking-[0.3em]">
              Sitemap
            </h4>

            <ul className="space-y-2 sm:space-y-4 text-xs sm:text-sm text-gray-300 font-semibold">
              {[
                { name: "Home", link: "/" },
                ...
                <li key={i}>
                  <Link
                    href={item.link}
                    className="hover:text-white flex items-center gap-2 sm:gap-3 group"
                  >
          ...
          <div>
            ...
            <ul className="space-y-3 sm:space-y-5 text-xs sm:text-sm text-gray-300 font-semibold">
              ...
              <li className="flex items-center gap-2 sm:gap-3 hover:text-white transition break-all">
              ...
              <li className="pt-2 sm:pt-3 mt-2 border-t border-white/5">
                <span className="text-[8px] sm:text-[9px] text-[#C79A3B] block font-black tracking-widest uppercase mb-1">
                  Registration
                </span>
                <span className="text-[10px] sm:text-xs font-mono opacity-90">
      ...
      {/* Bottom */}
      <div className="py-4 sm:py-5 px-4 sm:px-6 flex flex-col md:flex-row justify-between items-center text-[8px] sm:text-[10px] md:text-[11px] font-bold uppercase tracking-[0.1em] sm:tracking-[0.2em] text-gray-400 max-w-7xl mx-auto gap-2 sm:gap-4">
