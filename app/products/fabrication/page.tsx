...
export default function MaterialHandlingPage() {
  ...
  return (
    <main className="bg-[#f8fafc] min-h-screen overflow-x-hidden">
      ...
      {/* ================= HERO SECTION ================= */}
      <section className="relative bg-[#0B2E5B] py-20 sm:py-28 md:py-40 text-center text-white px-4 sm:px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 rounded-full border border-white/20 bg-white/5 backdrop-blur-md mb-6 sm:mb-8"
          >
              ...
              {filteredProducts.map((item, index) => (
                ...
                >
                  ...
                  <div className="p-5 sm:p-8 md:p-10 bg-gradient-to-t from-slate-50/50 to-transparent relative border-t border-slate-50">
                    ...
                    <p className="text-slate-500 mb-4 sm:mb-6 leading-relaxed font-medium text-xs sm:text-sm line-clamp-3">
                      {item.description}
                    </p>
                    ...
                    <div className="flex items-center justify-between mt-auto">
                      ...
                      <div className="flex flex-col items-end opacity-20">
                        <Layers size={14} />
                        <span className="text-[6px] sm:text-[7px] font-bold uppercase mt-1">ISO</span>
                      </div>
                    </div>
                  </div>
      ...
      <div className="py-6 sm:py-10 text-center opacity-[0.05] pointer-events-none">
        <p className="text-4xl sm:text-6xl md:text-8xl font-black tracking-tight">
          SRIVRUKSH
        </p>
      </div>
